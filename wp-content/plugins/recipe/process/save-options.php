...
function r_save_options(){
	...
	if(!current_user_can(RECIPE_OPTIONS_CAPABILITY)){
		die(__('You are not allowed access to do this', 'recipe'));
	}
	...
	$recipe_opts['submission_login_required'] = absint($_POST['r_submission_login_required']);
